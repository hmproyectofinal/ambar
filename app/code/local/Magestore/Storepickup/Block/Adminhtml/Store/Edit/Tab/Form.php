...
//        if (!$this->getRequest()->getParam('id')) {
		...
		/*Edit by lbale - Brandlive */
		$fieldset->addField('pickup_enabled', 'select', array(
			'label' => Mage::helper('storepickup')->__('Pickup Enabled'),
			'name' => 'pickup_enabled',
			'values' => array(
				array(
					'value' => 1,
			...
			'note' => Mage::helper('storepickup')->__('Store is available to select in checkout'),
